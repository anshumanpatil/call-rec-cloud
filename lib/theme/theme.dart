...
const TextStyle extraBold16Black =
    TextStyle(color: blackColor, fontSize: 16.0, fontWeight: FontWeight.w800);
...
const TextStyle bold10Primary =
    TextStyle(color: primaryColor, fontSize: 10.0, fontWeight: FontWeight.w700);
...
const TextStyle bold10Grey =
    TextStyle(color: greyColor, fontSize: 10.0, fontWeight: FontWeight.w700);

const TextStyle bold16Grey =
    TextStyle(color: greyColor, fontSize: 16.0, fontWeight: FontWeight.w700);

const TextStyle bold11Black =
    TextStyle(color: blackColor, fontSize: 11.0, fontWeight: FontWeight.w700);

const TextStyle semibold25Primary =
    TextStyle(color: primaryColor, fontSize: 25.0, fontWeight: FontWeight.w600);
...
const TextStyle semibold13White =
    TextStyle(color: whiteColor, fontSize: 13.0, fontWeight: FontWeight.w600);
...
const TextStyle semibold13Black =
    TextStyle(color: blackColor, fontSize: 13.0, fontWeight: FontWeight.w600);
...
const TextStyle medium12Primary =
    TextStyle(color: primaryColor, fontSize: 12.0, fontWeight: FontWeight.w500);
...
const TextStyle medium13White =
    TextStyle(color: whiteColor, fontSize: 13.0, fontWeight: FontWeight.w500);
...
const TextStyle medium13Black =
    TextStyle(color: blackColor, fontSize: 13.0, fontWeight: FontWeight.w500);

const TextStyle medium12Black =
    TextStyle(color: blackColor, fontSize: 12.0, fontWeight: FontWeight.w500);

const TextStyle medium10Black =
    TextStyle(color: blackColor, fontSize: 10.0, fontWeight: FontWeight.w500);

const TextStyle medium17Grey =
    TextStyle(color: greyColor, fontSize: 17.0, fontWeight: FontWeight.w500);
...
const TextStyle regular20White =
    TextStyle(color: whiteColor, fontSize: 20.0, fontWeight: FontWeight.w400);
...
const TextStyle regular13White =
    TextStyle(color: whiteColor, fontSize: 13.0, fontWeight: FontWeight.w400);

const TextStyle regular12White =
    TextStyle(color: whiteColor, fontSize: 12.0, fontWeight: FontWeight.w400);

const TextStyle regular20Black =
    TextStyle(color: blackColor, fontSize: 20.0, fontWeight: FontWeight.w400);
...
const TextStyle regular13Black =
    TextStyle(color: blackColor, fontSize: 13.0, fontWeight: FontWeight.w400);

const TextStyle regular12Black =
    TextStyle(color: blackColor, fontSize: 12.0, fontWeight: FontWeight.w400);
...
const TextStyle regular13Grey =
    TextStyle(color: greyColor, fontSize: 13.0, fontWeight: FontWeight.w400);
